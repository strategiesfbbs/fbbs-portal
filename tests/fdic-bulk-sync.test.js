...
const RIS_ROW = {
  ...
  SCPLEDGE: 52000, SCAF: 158000, IGLSEC: -12, EQ: 78000, RBCT1J: 79000,
  ...
  NTLNLSR: 0.07, DEPLGAMT: 162000, NUMEMP: 151, OFFDOM: 11,
  BRO: 6000, SC: 160000, DEPNI: 174000, LNRE: 442000, LNAG: 3600, LNCI: 15000, LNCON: 21000,
};
...
(async () => {
  ...
  const dry = await sync.syncFdicQuarter(tmpDir, { dryRun: true, fetchImpl });
  ...
  const real = await sync.syncFdicQuarter(tmpDir, { fetchImpl });
